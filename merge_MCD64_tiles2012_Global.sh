#!/bin/bash
#-----------------------------------------------------------------------
# Program written to merge MODIS tiles into a single global files
# Bernardo Mota (bernardo.mota@jrc.ec.europa.eu)
# Date: 29 October 2015
#-----------------------------------------------------------------------

echo "================================================================"
echo "= Script to merge and process BA MODIS tiles for MCD64A1"
echo "================================================================"

rundir="/home/wildube/Datasets/Global_BA_datasets/MCD64A1/HDF/"
...
#composite=(001 032 060 091 121 152 182 213 244 274 305 335) 	# for non leap-years
composite=(001 032 061 092 122 153 183 214 245 275 306 336)	# for leap-years

mes=(01 02 03 04 05 06 07 08 09 10 11 12)


# run for Portugal
#out_dir2="/home/admin/bernardo/BA_datasets/ConvFiles/"
out_dir2="/home/wildube/CompositeData/AgreFireData/MCD64/"

out_dir="/home/wildube/BA_make"


#patterns_africa="h16v05 h16v06 h16v07 h16v08 h17v05 h17v06 h17v07 h17v08 h18v05 h18v06 h18v07 h18v08 h19v05 h19v06 h19v07 h19v08 h19v09 h19v10 h19v11 h19v12 h20v05 h20v06 h20v07 h20v08 h20v09 h20v10 h20v11 h20v12 h21v06 h21v07 h21v08 h21v09 h21v10 h21v11 h22v07 h22v08 h22v09 h22v10 h22v11 h23v07 h23v08 h23v10 h23v11"
...
do
	...
	do
		...
		python convert_MCD64A1.py ${fiche} $out_dir2$tilename.tif 
	...
	python /home/wildube/BA_make/convert_RGMCD64.py global_y${year}c${mes[$compo]}_ll.tif 0 0.5
	python /home/wildube/BA_make/convert_RGMCD64.py global_y${year}c${mes[$compo]}_ll.tif 0 0.25
	python /home/wildube/BA_make/convert_RGMCD64.py global_y${year}c${mes[$compo]}_ll.tif 0 0.10
	python /home/wildube/BA_make/convert_RGMCD64.py global_y${year}c${mes[$compo]}_ll.tif 0 0.05
